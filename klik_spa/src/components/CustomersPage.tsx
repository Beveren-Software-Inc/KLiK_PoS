...
//   return (
//     <div className="min-h-screen bg-red-50 dark:bg-gray-900 flex ">
//       <RetailSidebar/>
...
//        </div>
//         <div className="flex-1 px-6 py-8 bg-red-400 mt-16 ml-20 flex flex-col items-center">
...
export default function CustomersPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
      ...
      {/* Main Content */}
      <div className="flex-1 ml-20 pt-20 px-6 py-8">

...
from klik_pos.api.customer import get_customers, check_customer_permission
...
class TestCustomerAPI(FrappeTestCase):
    ...
    def test_get_customers_basic_functionality(self, mock_user_permissions, mock_company_currency, mock_pos_profile, mock_get_doc, mock_db_get_value, mock_get_stats):
        """Test basic functionality of get_customers function"""

        mock_pos_profile.return_value = MagicMock(
            custom_business_type="B2C",
            customer_groups=[]
        )
        ...
        with patch('frappe.get_all') as mock_get_all:
            ...
            # Mock DB value lookups for contact/address
    ...
    def test_check_customer_permission_invalid_customer(self, mock_pos_profile):
        ...
        # Mock frappe.get_doc to raise exception for non-existent customer
        with patch('frappe.get_doc') as mock_get_doc:
